...
import type { Product as _Product, ProductId as _ProductId, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
...
function from_candid_record_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        externalLink: record_opt_to_undefined(from_candid_opt_n9(_uploadFile, _downloadFile, value.externalLink)),
        cashfreeUrl: value.cashfreeUrl,
